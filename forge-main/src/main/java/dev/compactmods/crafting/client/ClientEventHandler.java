...
public class ClientEventHandler {
    ...
    private static void doFieldPreviewRender(RenderLevelStageEvent event, Minecraft mc) {
        ...
        mc.level.getCapability(CCCapabilities.FIELDS)
                .ifPresent(fields -> fields.getFields()
                        ...
                        .forEach(field -> {
                            ...
                            PoseStack stack = getPoseStack(event, field, mainCamera);
    ...
    @NotNull
    private static  PoseStack getPoseStack(RenderLevelStageEvent event, IMiniaturizationField field, Camera mainCamera) {
